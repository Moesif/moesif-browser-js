...
if(!a.applicationId)throw Error("A moesif application id is required. Please obtain it through your settings at www.moesif.com");if(a.getTags&&!b.e(a.getTags))throw Error("getTags should be a function");if(a.getMetadata&&!b.e(a.getMetadata))throw Error("getMetadata should be a function");if(a.getApiVersion&&!b.e(a.getApiVersion))throw Error("identifyUser should be a function");if(a.maskContent&&!b.e(a.maskContent))throw Error("maskContent should be a function");if(a.skip&&!b.e(a.skip))throw Error("skip should be a function");
var c={};c.P=a.getTags||function(){};c.I=a.maskContent||function(a){return a};c.getMetadata=a.getMetadata||function(){};c.Y=a.skip||function(){return s};c.F=a.debug;c.D=a.callback;c.q=a.applicationId;c.A=a.apiVersion;this.c=c;this.o=localStorage.getItem("moesif_stored_user_id");this.h=localStorage.getItem("moesif_stored_session_id");m.log("moesif initiated");return this},start:function(){var b=this;if(this.l)return m.log("recording has already started, please call stop first."),s;m.log("moesif starting");
this.l=N(function(c){m.log("determining if should log: "+c.request.uri);var e=Object.assign({},c);b.o&&(e.user_id=b.o);b.h&&(e.session_token=b.h);e.tags=b.c.P(c)||"";if(b.c.A)e.request.api_version=b.c.A;b.c.I&&(e=b.c.I(e));b.c.getMetadata&&(e.metadata=b.c.getMetadata(e));!b.c.Y(c)&&!c.request.headers["X-Moesif-SDK"]?a(e,b.c.q,b.c.F,b.c.D):m.log("skipped logging for "+c.request.uri)});return!0},identifyUser:function(a,b){this.o=a;if(!this.c||!this.c.q)throw Error("Init needs to be called with a valid application Id before calling identify User.");
b&&c({user_id:a,session_token:this.h,metadata:b},this.c.q,this.c.F,this.c.D);localStorage.setItem("moesif_stored_user_id",a)},identifySession:function(a){this.h=a;localStorage.setItem("moesif_stored_session_id",a)},da:function(){return this.o},ca:function(){return this.h},stop:function(){if(this.l)this.l(),this.l=r}}}()})();
})();
