(function() {
(function(){var ga,ha,ia,ja,ka,la,ma,L,M,N,O,P,W;function na(a,b,d){p.log("processResponse for"+a._url);var f=(new Date).toISOString();if(d){var h=a._url?a._url.toLowerCase():a._url;if(h&&0>h.indexOf("moesif.com")&&0>h.indexOf("apirequest.io")){a:if((h=a._url)&&"string"===typeof h){var e=c.trim(h);if(0!==e.indexOf("http")){h=Ga+window.location.host+"/"+e.replace(/^\./,"").replace(/^\//,"");break a}}h={uri:h,verb:a._method,time:a._startTime,headers:a._requestHeaders};if(b)if("string"===typeof b)p.log("request post data is string"),
...
a));c.localStorage.remove(v(O,a));c.localStorage.remove(v(P,a))}function Na(a,b){var d=null,f=null;try{(f=H(P,b))&&"null"!==f&&(d=c.JSONDecode(f))}catch(h){y.error("failed to decode campaign data "+f),y.error(h)}var e;a:{try{f={};if(!b.disableUtm)var i=void 0,k=void 0,i=c.getUrlParams(),k=c.cookie.get("__utmz"),f=La(k,i)||{};if(!b.disableReferer){var g;b:{var l=document&&document.referrer;va.log(l);if(!c.isEmptyString(l))if(0===l.indexOf(location.protocol+"//"+location.host))va.log("referrer is the same so skipping");
else{var n;if(c.isEmptyString(l))n=null;else{var wa=l.split("/");n=3<=wa.length?wa[2]:null}g={referrer:l,referring_domain:n};break b}g=void 0}if(g)f.referrer=g.referrer,f.referring_domain=g.referring_domain}if(!b.disableRGclid){var j,Oa=c.getUrlParams(),m=c.getQueryParamByName("gclid",Oa);(j=c.isEmptyString(m)?void 0:m)&&(f.gclid=j)}e=f;break a}catch(Pa){y.log(Pa)}e=void 0}y.log("current campaignData");y.log(c.JSONEncode(e));var t;if(e)if(d){g=c.extend({},d,e);if(e&&e[q.UTM_SOURCE])for(t in q)g[q[t]]=
e[q[t]];t=g}else t=e;else t=d;y.log("merged campaignData");y.log(c.JSONEncode(t));try{if(a&&t&&!c.isEmptyObject(t)){var o=c.JSONEncode(t);a(P,o);!d&&t[q.UTM_SOURCE]&&a(W,o)}}catch(p){y.error("failed to persist campaign data"),y.error(p)}return t}function Z(a){var b=c.UUID();a&&a(N,b);return b}function Qa(a,b){var d=H(N,b);return d?d:Z(a)}function xa(a){try{return a.request.headers["X-Moesif-SDK"]}catch(b){return!1}}function Ra(a){if(!a)throw Error("options are required by moesif-browser-js middleware");
...
if(a.skip&&!c.isFunction(a.skip))throw Error("skip should be a function");}function ya(){j.log("moesif object creator is called");return{init:function(a){window||j.critical("Warning, this library need to be initiated on the client side");Ra(a);var b={};b.getTags=a.getTags||$;b.maskContent=a.maskContent||function(a){return a};b.getMetadata=a.getMetadata||$;b.skip=a.skip||function(){return!1};b.debug=a.debug;b.callback=a.callback||$;b.applicationId=a.applicationId;b.apiVersion=a.apiVersion;b.disableFetch=
...
var G={DEBUG:!1,LIB_VERSION:"1.8.11"},C;if("undefined"===typeof window){var B={hostname:""};C={navigator:{userAgent:""},document:{location:B,referrer:""},screen:{width:0,height:0},location:B}}else C=window;var B=Array.prototype,w=Object.prototype,J=B.slice,R=w.toString,T=w.hasOwnProperty,s=C.console,K=C.navigator,x=C.document,S=C.opera,U=C.screen,m=K.userAgent,aa=Function.prototype.bind,Ba=B.forEach,Ca=B.indexOf,Da=B.map,B=Array.isArray,ba={},c={trim:function(a){return a.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
...
c:e}};c.bind_instance_methods=function(a){for(var b in a)"function"===typeof a[b]&&(a[b]=c.bind(a[b],a))};c.each=function(a,b,d){if(!(null===a||void 0===a))if(Ba&&a.forEach===Ba)a.forEach(b,d);else if(a.length===+a.length)for(var c=0,h=a.length;c<h&&!(c in a&&b.call(d,a[c],c,a)===ba);c++);else for(c in a)if(T.call(a,c)&&b.call(d,a[c],c,a)===ba)break};c.escapeHTML=function(a){a&&c.isString(a)&&(a=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,
"&#039;"));return a};c.extend=function(a){c.each(J.call(arguments,1),function(b){for(var c in b)void 0!==b[c]&&(a[c]=b[c])});return a};c.isArray=B||function(a){return"[object Array]"===R.call(a)};c.isFunction=function(a){try{return/^\s*\bfunction\b/.test(a)}catch(b){return!1}};c.isArguments=function(a){return!(!a||!T.call(a,"callee"))};c.toArray=function(a){return!a?[]:a.toArray?a.toArray():c.isArray(a)||c.isArguments(a)?J.call(a):c.values(a)};c.map=function(a,b){if(Da&&a.map===Da)return a.map(b);
var d=[];c.each(a,function(a){d.push(b(a))});return d};c.keys=function(a){var b=[];if(null===a)return b;c.each(a,function(a,c){b[b.length]=c});return b};c.values=function(a){var b=[];if(null===a)return b;c.each(a,function(a){b[b.length]=a});return b};c.identity=function(a){return a};c.include=function(a,b){var d=!1;if(null===a)return d;if(Ca&&a.indexOf===Ca)return-1!=a.indexOf(b);c.each(a,function(a){if(d||(d=a===b))return ba});return d};c.includes=function(a,b){return-1!==a.indexOf(b)};c.inherit=
...
a(e[g],m)&&(j[d++]=e[g])}else if(e=d.match(Sa)){d=e[1];var o=e[2],m=e[3],p=e[4];d||(d="*");e=[];for(g=i=0;g<j.length;g++){n="*"==d?j[g].all?j[g].all:j[g].getElementsByTagName("*"):j[g].getElementsByTagName(d);for(l=0;l<n.length;l++)e[i++]=n[l]}j=[];d=0;switch(m){case "=":m=function(a){return a.getAttribute(o)==p};break;case "~":m=function(a){return a.getAttribute(o).match(RegExp("\\b"+p+"\\b"))};break;case "|":m=function(a){return a.getAttribute(o).match(RegExp("^"+p+"-?"))};break;case "^":m=function(a){return 0===
...
var ea=function(a){var b=Math.random().toString(36).substring(2,10)+Math.random().toString(36).substring(2,10);return a?b.substring(0,a):b};c.safewrap(function(a,b,c){for(var a=a+b,b=5381,f=0;f<a.length;f++)b=(b<<5)+b+a.charCodeAt(f),b&=b;return(b>>>0)%100<c});var Ta=/[a-z0-9][a-z0-9-]*\.[a-z]+$/i,Ua=/[a-z0-9][a-z0-9-]+\.[a-z.]{2,6}$/i,Ea=function(a){var b=Ua,c=a.split("."),c=c[c.length-1];if(4<c.length||"com"===c||"org"===c)b=Ta;return(a=a.match(b))?a[0]:""},E=null,V=null;if("undefined"!==typeof JSON)E=
JSON.stringify,V=JSON.parse;E=E||c.JSONEncode;V=V||c.JSONDecode;c.toArray=c.toArray;c.isObject=c.isObject;c.JSONEncode=c.JSONEncode;c.JSONDecode=c.JSONDecode;c.isBlockedUA=c.isBlockedUA;c.isEmptyObject=c.isEmptyObject;c.isEmptyString=c.isEmptyString;c.info=c.info;c.info.device=c.info.device;c.info.browser=c.info.browser;c.info.browserVersion=c.info.browserVersion;c.info.properties=c.info.properties;var D=w("parsers"),X=function(a){try{return{body:c.JSONDecode(a)}}catch(b){return D.log("JSON decode failed"),
D.log(b),{transfer_encoding:"base64",body:c.base64Encode(a)}}},oa=function(a){if(!a)return{};D.log("about to decode buffer");D.log(a);D.log(a.byteLength);if(0>=a.byteLength)return{};try{var b=(new TextDecoder("utf-8")).decode(a);try{return{body:c.JSONDecode(b)}}catch(d){return D.error(d),{transfer_encoding:"base64",body:c.base64Encode(b)}}}catch(f){return D.error(f),D.log(a),{transfer_encoding:"base64",body:"can not be decoded"}}},p=w("capture"),Ga="http:"===(document&&document.location.protocol)?
"http://":"https://",u=w("web3capture"),r=w("capture fetch"),va=w("referrer"),sa=w("utm"),q={UTM_SOURCE:"utm_source",UTM_MEDIUM:"utm_medium",UTM_CAMPAIGN:"utm_campaign",UTM_TERM:"utm_term",UTM_CONTENT:"utm_content"};L="moesif_stored_user_id";M="moesif_stored_company_id";O="moesif_stored_session_id";N="moesif_anonymous_id";P="moesif_campaign_data";W="moesif_initial_campaign";var y=w("campaign"),Va=w("lock"),Fa=function(a,b){b=b||{};this.storageKey=a;this.storage=b.storage||window.localStorage;this.pollIntervalMS=
b.pollIntervalMS||100;this.timeoutMS=b.timeoutMS||2E3};Fa.prototype.withLock=function(a,b,c){!c&&"function"!==typeof b&&(c=b,b=null);var f=c||(new Date).getTime()+"|"+Math.random(),h=(new Date).getTime(),e=this.storageKey,i=this.pollIntervalMS,k=this.timeoutMS,g=this.storage,l=e+":X",j=e+":Y",m=e+":Z",o=function(a){(new Date).getTime()-h>k?(Va.error("Timeout waiting for mutex on "+e+"; clearing lock. ["+f+"]"),g.removeItem(m),g.removeItem(j),q()):setTimeout(function(){try{a()}catch(c){b&&b(c)}},i*
...
f&&g.removeItem(l)}};try{if(Q(g,!0))q();else throw Error("localStorage support check failed");}catch(s){b&&b(s)}};var o=w("batch"),F=function(a,b){b=b||{};this.storageKey=a;this.storage=b.storage||window.localStorage;this.lock=new Fa(a,{storage:this.storage});this.storageExpiration=b.storageExpiration||216E5;this.pid=b.pid||null;this.memQueue=[]};F.prototype.enqueue=function(a,b,d){var f={id:ea(),flushAfter:(new Date).getTime()+2*b,payload:a};this.lock.withLock(c.bind(function(){var b;try{var c=this.readFromStorage();
